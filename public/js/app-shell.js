...
(function () {
  ...
  const NAV = [
    { group: 'Overview', items: [
      { id: 'hub', label: 'Atlas Home', icon: I.home, href: '/atlas/' },
    ]},
    { group: 'Foundations', items: [
      { id: 'foundations', label: 'Foundations', icon: I.found, href: '/modules/foundations/', badge: 'start' },
      { id: 'mathematics', label: 'Mathematics', icon: I.math, href: '/modules/mathematics/', badge: '10' },
      { id: 'data-analysis', label: 'Data Analysis', icon: I.data, href: '/modules/data-analysis/', badge: '8' },
      { id: 'machine-learning', label: 'Machine Learning', icon: I.ml, href: '/modules/machine-learning/', badge: '8' },
      { id: 'deep-learning', label: 'Deep Learning Lab', icon: I.dl, href: '/modules/deep-learning/', badge: '8' },
    ]},
    { group: 'Language & Generation', items: [
      { id: 'nlp', label: 'Language & Generation', icon: I.nlp, href: '/modules/nlp/', badge: '8' },
      { id: 'transformers', label: 'Transformers & LLMs', icon: I.tf, href: '/modules/transformers/', badge: '8' },
      { id: 'llm-agents', label: 'LLM & Agents Lab', icon: I.llm, href: '/modules/llm-agents/', badge: '8' },
      { id: 'generative', label: 'Generative AI', icon: I.gen, href: '/modules/generative/', badge: '8' },
      { id: 'xai', label: 'Explainable AI', icon: I.xai, href: '/modules/xai/', badge: '8' },
    ]},
    { group: 'Applied & Frontier', items: [
      { id: 'cv', label: 'Computer Vision', icon: I.cv, href: '/modules/computer-vision/', badge: 'new' },
      { id: 'rl', label: 'Reinforcement Learning', icon: I.rl, href: '/modules/reinforcement-learning/', badge: 'new' },
      { id: 'timeseries', label: 'Time Series', icon: I.ts, href: '/modules/time-series/', badge: 'new' },
      { id: 'prompting', label: 'Prompt Engineering', icon: I.prompt, href: '/modules/prompt-engineering/', badge: 'new' },
      { id: 'ethics', label: 'AI Ethics & Safety', icon: I.ethics, href: '/modules/ai-ethics/', badge: 'new' },
    ]},
    { group: 'Systems & Research', items: [
      { id: 'programming', label: 'Code & Stack', icon: I.code, href: '/modules/programming/', badge: '8' },
      { id: 'etl', label: 'ETL & Data Eng.', icon: I.etl, href: '/modules/etl/', badge: '8' },
      { id: 'mlops', label: 'MLOps', icon: I.ops, href: '/modules/mlops/', badge: '8' },
      { id: 'research', label: 'Research Lab', icon: I.research, href: '/modules/research/', badge: '8' },
    ]},
  ];

  const mark = `<img class="brand-mark" src="/assets/atlas-mark.png" alt="" style="width:26px;height:26px" />`;

  let html = `<aside class="side" id="side">
    <a class="side-brand" href="/">${mark} AI Atlas</a>
